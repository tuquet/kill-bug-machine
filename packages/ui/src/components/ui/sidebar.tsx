...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@kbm/ui/src/components/ui/sheet"
import { Skeleton } from "@kbm/ui/src/components/ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@kbm/ui/src/components/ui/tooltip"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:h-[calc(100vh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
        className
      )}
      {...props}
    />
