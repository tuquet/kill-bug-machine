    ...
    <form className={cn('flex flex-col gap-6', className)} onSubmit={(e) => { e.preventDefault(); toast.success('Account created successfully!'); }} {...props}>
      <FieldGroup>
        ...
        <Field>
          ...
          <Input id="password" type="password" autoComplete="new-password" required className="bg-background" />
          <FieldDescription>Must be at least 8 characters long.</FieldDescription>
        </Field>
        <Field>
          <FieldLabel htmlFor="confirm-password">Confirm Password</FieldLabel>
          <Input id="confirm-password" type="password" autoComplete="new-password" required className="bg-background" />
